...
pass <- read_csv("https://raw.githubusercontent.com/jakeberberian/fantasy-football/master/data/pass.csv?token=AKLAJHSNHCWTZWKSMMV5P5S7ANRQC")

rush <- read_csv("https://raw.githubusercontent.com/jakeberberian/fantasy-football/master/data/rush.csv?token=AKLAJHRNGS5HOWQH6B4JYHS7ANTNG")

receive <- read_csv("https://raw.githubusercontent.com/jakeberberian/fantasy-football/master/data/receive.csv?token=AKLAJHW6IWBGOASR7OTOYXS7ANR26")

fantasy <- read_csv("https://raw.githubusercontent.com/jakeberberian/fantasy-football/master/data/fantasy.csv?token=AKLAJHQBOBBY5QLA5SYXN627ANSQU")
```
